...
* `comps_solved.py` Solves different ilustrative examples of octahedron comparisons. The visuals of the examples are provided in OCT_examples.pdf, and the output text is provided in `output.txt`.
